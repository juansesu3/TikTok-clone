...
const Upload = () => {
  ...
  return (
    <>
      <UploadLayout>
        <div className="w-full h-full mt-[80px] mb-[20px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
          <div>
            ...
            {!fileDisplay ? (
              <label
                ...
                className="md:mx-0 mx-auto mt-4 mb-6 flex flex-col 
                        items-center justify-center w-full max-w-[260px] h-[570px] 
              ...
              >
                ...
                <label
                  htmlFor="fileInput"
                  className="px-2 py-2 mt-8 text-white text-[15px] w-[80%] bg-[#F02C56] rounded-sm cursor-pointer"
                >
                  Select file
                </label>
                <input
              ...
              <div
                className="md:mx-0 mx-auto mt-4 md:mb-12 md:16 flex items-center
                justify-center w-full max-w-[260px] h-[540px] p-3 rounded-2xl cursor-pointer relative"
              >
                {isUploading ? (
